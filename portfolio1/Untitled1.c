...
while(1)
  {
    cout << "States of sensor will change with time idle_0    sensing_1    processing_2 ";
    num=0;
    (fsm.*ptrs[num])();
    cout << "Currently....Idle....state..0." << endl;
    _sleep(5000);
    cout << "Going.to sensing...state..in 5 seconds.." << endl;
    _sleep(5000);
    num=1;
    if (num==1){
    cout << "Sensing data....state..1." << endl;

    _sleep(5000); // pauses for 5 seconds

    cout << "Processing data....state..2." << endl;
